...
public class UserEditRequestDTO implements Serializable {
    ...
    @Length(max = 255)
    @Pattern(regexp = User.REGEX_EMAIL)
    ...
    public UserEditRequestDTO(long id, String username, String password, String email, String phoneNumber, String fullName, String roleName) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        UserEditRequestDTO entity = (UserEditRequestDTO) o;
